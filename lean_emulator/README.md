...
```
cmake -S . -B build -DCMAKE_BUILD_TYPE=RelWithDebInfo -DSAIL_MODULES="H;Zca;Zicbom_insts;Zicboz;Zicsr_insts;Zkr;Zicfiss_insts;Zimop;Zaamo;Sscofpmf;Zihpm;postlude" -DENABLE_LEAN_EMULATOR_TESTS=TRUE
