...
def plat_mtval_has_breakpoint_pc  (_:Unit) : Bool := false
def plat_mtval_has_load_access_fault_addr  (_:Unit) : Bool := false
def plat_mtval_has_load_misalign_addr  (_:Unit) : Bool := false
def plat_mtval_has_samo_access_fault_addr  (_:Unit) : Bool := false
def plat_mtval_has_samo_misalign_addr  (_:Unit) : Bool := false
def plat_mtval_has_fetch_access_fault_addr  (_:Unit) : Bool := false
def plat_mtval_has_fetch_misalign_addr  (_:Unit) : Bool := false
