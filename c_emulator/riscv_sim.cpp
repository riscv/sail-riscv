...
static void setup_options(CLI::App &app) {
  ...
  app.add_flag("--enable-experimental-extensions", rv_enable_experimental_extensions, "Enable experimental extensions");
  ...
  app
    .add_flag("--trace-platform", config_print_platform, "Enable trace output for privilege changes, MMIO, interrupts");
...
int inner_main(int argc, char **argv) {
  ...
  init_logs();
  log_callbacks log_cbs(config_print_reg, config_print_mem_access, config_use_abi_names, trace_log);
