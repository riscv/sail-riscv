...
bool config_print_clint_mem_access = false;
...
static void setup_options(CLI::App &app)
{
  ...
  app.add_flag("--trace-clint", config_print_clint_mem_access,
               "Enable trace output for CLINT memory accesses");
  ...
  app.add_flag_callback(
      "--trace-platform",
      [] {
        config_print_clint_mem_access = true;
