...
void log_callbacks::xreg_full_write_callback(model::Model &,
...
void log_callbacks::freg_write_callback(model::Model &, unsigned reg,
                                        sbits value)
{
...
void log_callbacks::csr_full_write_callback(model::Model &,
...
void log_callbacks::csr_full_read_callback(model::Model &,
                                           const_sail_string csr_name,
                                           unsigned reg, sbits value)
{
  if (trace_log != nullptr && config_print_reg) {
...
void log_callbacks::vreg_write_callback(model::Model &, unsigned reg,
                                        lbits value)
{
  if (trace_log != nullptr && config_print_reg) {
