...
Protocol for debuggers like GDB and LLDB, allowing them to connect to
the simulator.

To use the simulator in this mode, configure and build it with
`-DENABLE_GDBSERVER=TRUE`, and run it as:
...
If the debugger is quit, the simulator also exits.
