...
connection::connection(
  ...
  // Attach the handler to the model.  This cannot be done in its
  // constructor due to the restrictions of
...
void connection::handle_socket_error() {
  ...
  // Detach the handler from the model.
  m_handler->detach();
  ...
  // Shutdown the acceptor for a clean exit.
  m_acceptor.close();
}
